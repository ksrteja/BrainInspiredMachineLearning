...
# Last Modified : Thu 06 Oct 2016 11:44:01 PM PDT
#
...
def FRN(N=32, b=0.0, Win = None, rates_in = None, activation_function = rectlin):
    '''
...
def plotLIF(V, spikes, Vplot = 10):
    ...
    *Vplot*: A list indicating which neurons' membrane potentials should be 
    ...
    if V is not None:
        plt.subplot(211)
    plt.plot(t, n, '.', markersize=10, color='black')
    plt.ylim([-1, spikes.shape[1] + 1])
